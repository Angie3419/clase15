...
end.addImage("gameOver",final)
end.scale=0.5;
reinicioImagen = createSprite(300,140);

reinicioImagen.addImage("reiniciar",reinicio);
reinicioImagen.scale=0.5;

end.visible=false;

reinicioImagen.visible=false;
}
